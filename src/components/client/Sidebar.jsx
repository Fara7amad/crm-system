...
const Sidebar =({children})=>{
    ...
    return(
                ...
                <div className="top-section">
                    ...
                    animate="show"
                    exit="hidden"
                     className="header">CrmSystem</motion.h1  >}
                    
                    <div className="toggle">
                        {
                            (isOpen===false)?
                            <FontAwesomeIcon icon="bars" onClick={toggle}  />:<FontAwesomeIcon icon="xmark" onClick={toggle}/>
                        }
                ...
                <section className="routes">
                {
                    menuItem.map((item,index)=>(
                        ...
                        <AnimatePresence>
                            ...
                            animate="show"
                            exit="hidden"
                             className="link-text">{item.name}</motion.div>
                    ...
                    {
                        isOpen&&<div className="status">
                          <a href="#"> <FontAwesomeIcon icon="circle-user" className="prf" /></a>
