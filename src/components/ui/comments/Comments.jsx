   ...
   return(
    <div className="container">
      ...
      <p>Was great working with him</p>
       ...
       {
        showComment&& <textarea style={{width:showComment?"":"0px"}} className="input-box mb-2" value={comment} onChange={onChangeHandler} placeholder="Write a comment..."/>
       }
      
        {
            showComment&&<button className="submit-button" onClick={onClickHandler}>Submit </button>
        }
